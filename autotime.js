...
module.exports.config = {
  ...
  version: "3.0.0",
  role: 0,
  author: "Vincent Armenion",//lol don't change the author if you change it i will hack your Facebook account👿
...
module.exports.onLoad = async ({ api, getLang , utils }) => {
  const arrayData = {
      ...
      "02:00:00 AM": {
        message: "🔔 𝗔𝘂𝘁𝗼 𝗧𝗶𝗺𝗲:\n▬▬▬▬▬▬▬▬▬▬▬▬\n\n⏰ time now - 𝟬𝟮:𝟬𝟬 𝗔𝗠\n\n📌 don't forget to drunk your coffee and exercise your body ☕💪\𝗇\𝗇— 𝕺𝖜𝖓𝖊𝖗: 𝗩𝗜𝗡𝗖𝗘𝗡𝗧 𝗕𝗢𝗧\n▬▬▬▬▬▬▬▬▬▬▬▬", 
